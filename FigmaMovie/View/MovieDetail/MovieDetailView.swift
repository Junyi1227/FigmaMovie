    ...
    var body: some View {
        VStack(alignment:.leading,spacing:8){
            ...
            HStack(spacing:8){
                ...
                .frame(height:48)
                .background(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.3882352941, green: 0.3882352941, blue: 0.4588235294, alpha: 1)), Color(#colorLiteral(red: 0.231372549, green: 0.231372549, blue: 0.3019607843, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing))
                .cornerRadius(15)
