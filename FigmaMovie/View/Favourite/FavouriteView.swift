        ...
        NavigationView {
            ScrollView(.vertical) {
                LazyVGrid(columns: threeColumnGrid) {
                    ForEach(0 ..< 5) { num in
                        FavouriteCardView().id("xxxx" + String(num))
                    }
                }
        ...
        HStack(alignment: .top) {
            GeometryReader(content: { geometry in
                        ...
                        ZStack(alignment: .topLeading) {
                            ...
                            Rectangle()
                                ...
                                .background(LinearGradient(gradient: Gradient(colors: [
                                    Color(#colorLiteral(red: 0.09803921569, green: 0.09803921569, blue: 0.1490196078, alpha: 0)), Color(#colorLiteral(red: 0.09803921569, green: 0.09803921569, blue: 0.1490196078, alpha: 1))
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Text("""
                    image named 'xxx' found in asset catalog for /Users/jimmy/Library/Developer/CoreSimulator
                    /Devices/08286A50-7069-4A8D-A3AD-0A47A7124B26/data/Containers/Bundle/
                    Application/8A1D3A76-F5B5-40E7-BD14-25D2B79FF681/FigmaMovie.app
                    """)
